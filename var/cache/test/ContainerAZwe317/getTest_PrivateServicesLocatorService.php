...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Infrastructure\\DataFixtures\\AppFixtures' => ['privates', 'App\\Infrastructure\\DataFixtures\\AppFixtures', 'getAppFixturesService', true],
            'App\\Infrastructure\\Repository\\ExpertiseRepository' => ['privates', 'App\\Infrastructure\\Repository\\ExpertiseRepository', 'getExpertiseRepositoryService', true],
            'App\\Infrastructure\\Repository\\CityRepository' => ['privates', 'App\\Infrastructure\\Repository\\CityRepository', 'getCityRepositoryService', true],
            'App\\Infrastructure\\Repository\\CountryRepository' => ['privates', 'App\\Infrastructure\\Repository\\CountryRepository', 'getCountryRepositoryService', true],
            'App\\Infrastructure\\Repository\\CVRepository' => ['privates', 'App\\Infrastructure\\Repository\\CVRepository', 'getCVRepositoryService', true],
            'App\\Application\\City\\UseCase\\CreateCity' => ['privates', 'App\\Application\\City\\UseCase\\CreateCity', 'getCreateCityService', true],
            'App\\Application\\City\\UseCase\\GetAmount' => ['privates', 'App\\Application\\City\\UseCase\\GetAmount', 'getGetAmountService', true],
            'App\\Application\\City\\UseCase\\GetDemoCitiesList' => ['privates', 'App\\Application\\City\\UseCase\\GetDemoCitiesList', 'getGetDemoCitiesListService', true],
            'App\\Application\\Country\\UseCase\\CreateCountry' => ['privates', 'App\\Application\\Country\\UseCase\\CreateCountry', 'getCreateCountryService', true],
            'App\\Application\\Country\\UseCase\\GetAllCountries' => ['privates', 'App\\Application\\Country\\UseCase\\GetAllCountries', 'getGetAllCountriesService', true],
            'App\\Application\\Country\\UseCase\\GetDemoCountriesList' => ['privates', 'App\\Application\\Country\\UseCase\\GetDemoCountriesList', 'getGetDemoCountriesListService', true],
            'App\\Application\\Expertise\\UseCase\\CreateExpertise' => ['privates', 'App\\Application\\Expertise\\UseCase\\CreateExpertise', 'getCreateExpertiseService', true],
            'App\\Application\\Expertise\\UseCase\\GetAllExpertises' => ['privates', 'App\\Application\\Expertise\\UseCase\\GetAllExpertises', 'getGetAllExpertisesService', true],
            'App\\Application\\Expertise\\UseCase\\GetDemoExpertisesList' => ['privates', 'App\\Application\\Expertise\\UseCase\\GetDemoExpertisesList', 'getGetDemoExpertisesListService', true],
            'App\\Application\\Expertise\\UseCase\\GetRandomDemoExpertises' => ['privates', 'App\\Application\\Expertise\\UseCase\\GetRandomDemoExpertises', 'getGetRandomDemoExpertisesService', true],
            'App\\Application\\Homepage\\UseCase\\GetHomePageHtmlData' => ['privates', 'App\\Application\\Homepage\\UseCase\\GetHomePageHtmlData', 'getGetHomePageHtmlDataService', true],
            'App\\Application\\PaymentType\\UseCase\\CreatePaymentType' => ['privates', 'App\\Application\\PaymentType\\UseCase\\CreatePaymentType', 'getCreatePaymentTypeService', true],
            'App\\Application\\PaymentType\\UseCase\\GetAllPaymentTypes' => ['privates', 'App\\Application\\PaymentType\\UseCase\\GetAllPaymentTypes', 'getGetAllPaymentTypesService', true],
            'App\\Application\\PaymentType\\UseCase\\GetDemoPaymentTypesList' => ['privates', 'App\\Application\\PaymentType\\UseCase\\GetDemoPaymentTypesList', 'getGetDemoPaymentTypesListService', true],
            'App\\Application\\Student\\UseCase\\GetAmount' => ['privates', 'App\\Application\\Student\\UseCase\\GetAmount', 'getGetAmount2Service', true],
            'App\\Application\\StudyingMode\\UseCase\\CreateStudyingMode' => ['privates', 'App\\Application\\StudyingMode\\UseCase\\CreateStudyingMode', 'getCreateStudyingModeService', true],
            'App\\Application\\StudyingMode\\UseCase\\GetAllStudyingModes' => ['privates', 'App\\Application\\StudyingMode\\UseCase\\GetAllStudyingModes', 'getGetAllStudyingModesService', true],
            'App\\Application\\StudyingMode\\UseCase\\GetDemoStudyingModesList' => ['privates', 'App\\Application\\StudyingMode\\UseCase\\GetDemoStudyingModesList', 'getGetDemoStudyingModesListService', true],
            'App\\Application\\Teacher\\UseCase\\AddPaymentTypeToTeacher' => ['privates', 'App\\Application\\Teacher\\UseCase\\AddPaymentTypeToTeacher', 'getAddPaymentTypeToTeacherService', true],
            'App\\Application\\Teacher\\UseCase\\AddStudyingModeToTeacher' => ['privates', 'App\\Application\\Teacher\\UseCase\\AddStudyingModeToTeacher', 'getAddStudyingModeToTeacherService', true],
            'App\\Application\\Teacher\\UseCase\\GetAllTeachers' => ['privates', 'App\\Application\\Teacher\\UseCase\\GetAllTeachers', 'getGetAllTeachersService', true],
            'App\\Application\\Teacher\\UseCase\\GetTeacher' => ['privates', 'App\\Application\\Teacher\\UseCase\\GetTeacher', 'getGetTeacherService', true],
            'App\\Application\\Teacher\\UseCase\\GetTeacherHtmlData' => ['privates', 'App\\Application\\Teacher\\UseCase\\GetTeacherHtmlData', 'getGetTeacherHtmlDataService', true],
            'App\\Application\\Teacher\\UseCase\\SelectTeachers' => ['privates', 'App\\Application\\Teacher\\UseCase\\SelectTeachers', 'getSelectTeachersService', true],
            'App\\Application\\User\\UseCase\\CreateUser' => ['privates', 'App\\Application\\User\\UseCase\\CreateUser', 'getCreateUserService', true],
            'App\\Application\\User\\UseCase\\GetAllUsers' => ['privates', 'App\\Application\\User\\UseCase\\GetAllUsers', 'getGetAllUsersService', true],
            'App\\Infrastructure\\Factory\\CVFactory' => ['privates', 'App\\Infrastructure\\Factory\\CVFactory', 'getCVFactoryService', true],
            'App\\Infrastructure\\Factory\\StudentFactory' => ['privates', 'App\\Infrastructure\\Factory\\StudentFactory', 'getStudentFactoryService', true],
            'App\\Infrastructure\\Factory\\TeacherFactory' => ['privates', 'App\\Infrastructure\\Factory\\TeacherFactory', 'getTeacherFactoryService', true],
            'App\\Infrastructure\\Factory\\TeacherHasTeacherExpertisesFactory' => ['privates', 'App\\Infrastructure\\Factory\\TeacherHasTeacherExpertisesFactory', 'getTeacherHasTeacherExpertisesFactoryService', true],
            'App\\Infrastructure\\Factory\\UserFactory' => ['privates', 'App\\Infrastructure\\Factory\\UserFactory', 'getUserFactoryService', true],
            'App\\Infrastructure\\Form\\RegistrationFormType' => ['privates', 'App\\Infrastructure\\Form\\RegistrationFormType', 'getRegistrationFormTypeService', true],
            'App\\Infrastructure\\Form\\SelectTeachersFormType' => ['privates', 'App\\Infrastructure\\Form\\SelectTeachersFormType', 'getSelectTeachersFormTypeService', true],
            'App\\Infrastructure\\Repository\\PaymentTypeRepository' => ['privates', 'App\\Infrastructure\\Repository\\PaymentTypeRepository', 'getPaymentTypeRepositoryService', true],
            'App\\Infrastructure\\Repository\\StudentRepository' => ['privates', 'App\\Infrastructure\\Repository\\StudentRepository', 'getStudentRepositoryService', true],
            'App\\Infrastructure\\Repository\\StudyingModeRepository' => ['privates', 'App\\Infrastructure\\Repository\\StudyingModeRepository', 'getStudyingModeRepositoryService', true],
            'App\\Infrastructure\\Repository\\TeacherHasTeacherExpertisesRepository' => ['privates', 'App\\Infrastructure\\Repository\\TeacherHasTeacherExpertisesRepository', 'getTeacherHasTeacherExpertisesRepositoryService', true],
            'App\\Infrastructure\\Repository\\TeacherRepository' => ['privates', 'App\\Infrastructure\\Repository\\TeacherRepository', 'getTeacherRepositoryService', true],
            'App\\Infrastructure\\Repository\\UserRepository' => ['privates', 'App\\Infrastructure\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Infrastructure\\Services\\HelperService' => ['privates', 'App\\Infrastructure\\Services\\HelperService', 'getHelperServiceService', true],
            ...
            'Zenstruck\\Foundry\\ORM\\ResetDatabase\\OrmResetter' => ['privates', 'Zenstruck\\Foundry\\ORM\\ResetDatabase\\OrmResetter', 'getOrmResetterService', true],
            ...
            'App\\Domain\\Repository\\CityRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\CityRepository', 'getCityRepositoryService', true],
            'App\\Domain\\Repository\\CountryRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\CountryRepository', 'getCountryRepositoryService', true],
            'App\\Domain\\Repository\\ExpertiseRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\ExpertiseRepository', 'getExpertiseRepositoryService', true],
            'App\\Domain\\Repository\\PaymentTypeRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\PaymentTypeRepository', 'getPaymentTypeRepositoryService', true],
            'App\\Domain\\Repository\\StudentRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\StudentRepository', 'getStudentRepositoryService', true],
            'App\\Domain\\Repository\\StudyingModeRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\StudyingModeRepository', 'getStudyingModeRepositoryService', true],
            'App\\Domain\\Repository\\TeacherRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\TeacherRepository', 'getTeacherRepositoryService', true],
            'App\\Domain\\Repository\\UserRepositoryInterface' => ['privates', 'App\\Infrastructure\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Domain\\Services\\HelperServiceInterface' => ['privates', 'App\\Infrastructure\\Services\\HelperService', 'getHelperServiceService', true],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.l9SRDqi', 'get_ServiceLocator_L9SRDqiService', true],
            ...
            'App\\Infrastructure\\Repository\\ExpertiseRepository' => '?',
            'App\\Infrastructure\\Repository\\CityRepository' => '?',
            'App\\Infrastructure\\Repository\\CountryRepository' => '?',
            'App\\Infrastructure\\Repository\\CVRepository' => '?',
            'App\\Application\\City\\UseCase\\CreateCity' => '?',
            'App\\Application\\City\\UseCase\\GetAmount' => '?',
            'App\\Application\\City\\UseCase\\GetDemoCitiesList' => '?',
            'App\\Application\\Country\\UseCase\\CreateCountry' => '?',
            'App\\Application\\Country\\UseCase\\GetAllCountries' => '?',
            'App\\Application\\Country\\UseCase\\GetDemoCountriesList' => '?',
            'App\\Application\\Expertise\\UseCase\\CreateExpertise' => '?',
            'App\\Application\\Expertise\\UseCase\\GetAllExpertises' => '?',
            'App\\Application\\Expertise\\UseCase\\GetDemoExpertisesList' => '?',
            'App\\Application\\Expertise\\UseCase\\GetRandomDemoExpertises' => '?',
            'App\\Application\\Homepage\\UseCase\\GetHomePageHtmlData' => '?',
            'App\\Application\\PaymentType\\UseCase\\CreatePaymentType' => '?',
            'App\\Application\\PaymentType\\UseCase\\GetAllPaymentTypes' => '?',
            'App\\Application\\PaymentType\\UseCase\\GetDemoPaymentTypesList' => '?',
            'App\\Application\\Student\\UseCase\\GetAmount' => '?',
            'App\\Application\\StudyingMode\\UseCase\\CreateStudyingMode' => '?',
            'App\\Application\\StudyingMode\\UseCase\\GetAllStudyingModes' => '?',
            'App\\Application\\StudyingMode\\UseCase\\GetDemoStudyingModesList' => '?',
            'App\\Application\\Teacher\\UseCase\\AddPaymentTypeToTeacher' => '?',
            'App\\Application\\Teacher\\UseCase\\AddStudyingModeToTeacher' => '?',
            'App\\Application\\Teacher\\UseCase\\GetAllTeachers' => '?',
            'App\\Application\\Teacher\\UseCase\\GetTeacher' => '?',
            'App\\Application\\Teacher\\UseCase\\GetTeacherHtmlData' => '?',
            'App\\Application\\Teacher\\UseCase\\SelectTeachers' => '?',
            'App\\Application\\User\\UseCase\\CreateUser' => '?',
            'App\\Application\\User\\UseCase\\GetAllUsers' => '?',
            'App\\Infrastructure\\Factory\\CVFactory' => '?',
            'App\\Infrastructure\\Factory\\StudentFactory' => '?',
            'App\\Infrastructure\\Factory\\TeacherFactory' => '?',
            'App\\Infrastructure\\Factory\\TeacherHasTeacherExpertisesFactory' => '?',
            'App\\Infrastructure\\Factory\\UserFactory' => '?',
            'App\\Infrastructure\\Form\\RegistrationFormType' => '?',
            'App\\Infrastructure\\Form\\SelectTeachersFormType' => '?',
            'App\\Infrastructure\\Repository\\PaymentTypeRepository' => '?',
            'App\\Infrastructure\\Repository\\StudentRepository' => '?',
            'App\\Infrastructure\\Repository\\StudyingModeRepository' => '?',
            'App\\Infrastructure\\Repository\\TeacherHasTeacherExpertisesRepository' => '?',
            'App\\Infrastructure\\Repository\\TeacherRepository' => '?',
            'App\\Infrastructure\\Repository\\UserRepository' => '?',
            'App\\Infrastructure\\Services\\HelperService' => '?',
            ...
            'App\\Domain\\Repository\\CityRepositoryInterface' => '?',
            'App\\Domain\\Repository\\CountryRepositoryInterface' => '?',
            'App\\Domain\\Repository\\ExpertiseRepositoryInterface' => '?',
            'App\\Domain\\Repository\\PaymentTypeRepositoryInterface' => '?',
            'App\\Domain\\Repository\\StudentRepositoryInterface' => '?',
            'App\\Domain\\Repository\\StudyingModeRepositoryInterface' => '?',
            'App\\Domain\\Repository\\TeacherRepositoryInterface' => '?',
            'App\\Domain\\Repository\\UserRepositoryInterface' => '?',
            'App\\Domain\\Services\\HelperServiceInterface' => '?',
