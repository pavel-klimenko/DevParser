...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Infrastructure\\Http\\HomePageController' => 'getHomePageControllerService',
            'App\\Infrastructure\\Http\\Security\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Infrastructure\\Http\\Teacher\\Controller\\TeacherController' => 'getTeacherControllerService',
    ...
    {
        $container->services['doctrine.dbal.default_connection'] = $instance = ($container->privates['doctrine.dbal.connection_factory'] ?? self::getDoctrine_Dbal_ConnectionFactoryService($container))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'use_savepoints' => true, 'driver' => 'pdo_mysql', 'idle_connection_ttl' => 600, 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collation' => 'utf8mb4_0900_ai_ci', 'collate' => 'utf8mb4_0900_ai_ci']], ($container->privates['doctrine.dbal.default_connection.configuration'] ?? self::getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)), ($container->privates['doctrine.dbal.default_connection.event_manager'] ?? self::getDoctrine_Dbal_DefaultConnection_EventManagerService($container)), []);
    ...
    protected static function get_Doctrine_Orm_DefaultMetadataDriverService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Domain/Entity')], true)), 'App\\Domain\\Entity');
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Infrastructure\\Http\\HomePageController', 'App\\Infrastructure\\Http\\Security\\Controller\\SecurityController', 'App\\Infrastructure\\Http\\Teacher\\Controller\\TeacherController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['doctrine.orm.default_attribute_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Domain/Entity')], true);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setEntityNamespaces(['App' => 'App\\Domain\\Entity']);
        ...
        $instance->addCustomNumericFunction('rand', 'DoctrineExtensions\\Query\\Mysql\\Rand');
