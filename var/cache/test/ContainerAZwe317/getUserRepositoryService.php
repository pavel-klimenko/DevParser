...
{
    /**
     * Gets the private 'App\Infrastructure\Repository\UserRepository' shared autowired service.
     *
     * @return \App\Infrastructure\Repository\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/Repository/UserRepository.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container));

        if (isset($container->privates['App\\Infrastructure\\Repository\\UserRepository'])) {
            return $container->privates['App\\Infrastructure\\Repository\\UserRepository'];
        }

        return $container->privates['App\\Infrastructure\\Repository\\UserRepository'] = new \App\Infrastructure\Repository\UserRepository($a, ($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
