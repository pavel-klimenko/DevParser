...
class ZenstruckFoundryConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('enable_auto_refresh_with_lazy_objects', $value)) {
            $this->_usedProperties['enableAutoRefreshWithLazyObjects'] = true;
            $this->enableAutoRefreshWithLazyObjects = $value['enable_auto_refresh_with_lazy_objects'];
            unset($value['enable_auto_refresh_with_lazy_objects']);
        }
        ...
        if (array_key_exists('persistence', $value)) {
            $this->_usedProperties['persistence'] = true;
            $this->persistence = new \Symfony\Config\ZenstruckFoundry\PersistenceConfig($value['persistence']);
